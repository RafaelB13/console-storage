...
![build](https://github.com/rafaelb13/console-storage/workflows/Go/badge.svg) ![license](https://img.shields.io/badge/license-AGPL%20V3-blue)
...
```
go install github.com/rafaelb13/console-storage/cmd/console@latest
```
...
Please follow console [Contributor's Guide](https://github.com/rafaelb13/console-storage/blob/master/CONTRIBUTING.md)
